...
const PaginationButton = styled.button`
  background-color: ${(props) =>
    props.active ? " var(--color-blue-600)" : "var(--color-grey-50)"};
  color: ${(props) => (props.active ? " var(--color-blue-50)" : "inherit")};
  border: none;
  ...
  return (
    <StyledPagination>
      <P>
        ...
        <span>{currentPage * PAGE_SIZE}</span> of <span>{count}</span> bookings
      </P>
